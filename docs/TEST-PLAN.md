...
- Real device, 2026-09-26: the parent played set 1 on an iPhone (Safari) and heard the voice; the parent approved set 1's content.
- **Not run:** real iPad Safari (audio unlock/resume, rotation, touch ergonomics). Mocked audio success does not prove audible playback on iPad.
